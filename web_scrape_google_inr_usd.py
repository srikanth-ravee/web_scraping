...
import smtplib
#Credentials
#Store your gmail login and password in secred.py
import secred


try:
    browser = webdriver.Chrome("C:/Program Files (x86)/chromedriver_win32/chromedriver.exe") #Default Path. Change as required
    ...
    print("web scraping process failed")

gmail_user = secred.gmail_user
gmail_password = secred.gmail_password
sent_from = gmail_user
to = [secred.recipient_1,secred.recipient_2] #Add more emails to this list as required
